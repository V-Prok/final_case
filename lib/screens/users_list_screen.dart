...
import 'package:final_case_2/model/user.dart';
import 'package:final_case_2/utils/constants.dart';
...
ListView _usersListView(data) {
  return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return _userListTile(data[index].name, data[index].email, Icons.perm_identity);
      });
}
